...
const Navbar = async () => {
    ...
    return (
        <div className="flex items-center justify-between p-4">
            {/* SEARCH BAR */}
            <div className="hidden md:flex items-center gap-2 items-center text-xs rounded-full ring-[1.5px] ring-black-300 px-2">
            ...
            <div className="flex items-center gap-6 justify-end w-full">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-black-500 text-right">{user?.publicMetadata?.role as string}</span>
                </div>
